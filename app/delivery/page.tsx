...
type Assignment = { id:string; order_id:string; status:string; customer_name:string; phone:string; address:string; total:number; payment_status:string; items?:any[]; updated_at?:string; assigned_at?:string };
